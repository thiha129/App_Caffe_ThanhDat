...
import {
  ...
  LogBox, ProgressBarAndroid, Platform,PixelRatio
} from 'react-native'
...
const OtpScreen: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (abcx == '1') {
      ...
      navigation.navigate('RegisterInforUser', { Number: route.params.Number, code: b });
    } else if (abcx == '2') {
      console.log('hợp lệ');
      ToastAndroid.showWithGravityAndOffset(
  ...
  const signin = () => {
    ...
    if (stringWithoutCommas == undefined) {
      ...
      dispatch(actions.verifyAccount.verifyAccountRequest({ phonenumber: route.params.Number, code: stringWithoutCommas }));
      // navigation.navigate('RegisterInforUser', { Number: route.params.Number, code: stringWithoutCommas });
    }
  }
